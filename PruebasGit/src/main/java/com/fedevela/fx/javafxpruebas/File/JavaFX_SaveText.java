 ...
 *
 * @author fvelazquez
 * http://java-buddy.blogspot.mx/2012/05/save-file-with-javafx-filechooser.html
 */
public class JavaFX_SaveText extends Application {
    ...
    private void SaveFile(String content, File file){
        try {
            ...
            Logger.getLogger(JavaFX_SaveText.class.getName()).log(Level.SEVERE, null, ex);
        }
