package com.fedevela.Encriptar;
...
/**
 *  http://www.devtroce.com/2009/12/05/encriptar-desencriptar-con-java-en-aes-256/
 * Muchas veces necesitamos encriptar o desencriptar ficheros con nuestras aplicaciones, 
 * siempre el dilema es a la hora de elegir cual método utilizar para esto. 
 * Hoy día uno de los más seguros y complejos, pero sencillos de implementar es 
 * AES (Advanced Encryptation Standard) tambien conocido en la práctica como el 
 * algoritmo Rijndael (aunque estrictamente no son el mismo algoritmo) el cual 
 * “reemplazo” a su predecesor DES, y está catalogado entre los algoritmos de 
 * criptografía simétrica. AES tiene un tamaño de bloque fijo de 128 bits y 
 * tamaños de llave de 128, 192 ó 256 bits, en este caso mostraré un ejemplo 
 * de como implementar esto en Java con 256 bits.
 * 
 * 
